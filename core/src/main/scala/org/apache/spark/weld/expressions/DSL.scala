...
import org.apache.spark.weld._


object DSL {
  trait IdentifierConversions {
    val id: Identifier
    def bool: Identifier = id.copy(dataType = org.apache.spark.weld.bool)
    def u8: Identifier = id.copy(dataType = org.apache.spark.weld.u8)
    def i8: Identifier = id.copy(dataType = org.apache.spark.weld.i8)
    def u16: Identifier = id.copy(dataType = org.apache.spark.weld.u16)
    def i16: Identifier = id.copy(dataType = org.apache.spark.weld.i16)
    def u32: Identifier = id.copy(dataType = org.apache.spark.weld.u32)
    def i32: Identifier = id.copy(dataType = org.apache.spark.weld.i32)
    def u64: Identifier = id.copy(dataType = org.apache.spark.weld.u64)
    def i64: Identifier = id.copy(dataType = org.apache.spark.weld.i64)
    def f32: Identifier = id.copy(dataType = org.apache.spark.weld.f32)
    def f64: Identifier = id.copy(dataType = org.apache.spark.weld.f64)
